...
<div className="max-w-[660px] max-h-[442px] rounded-3xl bg-[#3e1f9c] items-center  h-1/2 w-5/6 sm:w-2/3">
<div className="flex justify-end pr-8 pt-8">
<button className="text-[#c70074] text-xl sm:text-3xl" onClick={()=>updatesingin(false)}><IoClose /></button>
</div>
<div className="mt-6 px-6 sm:mt-20">
