...
function Signup() {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center text-red-400 bg-opacity-30 backdrop-blur-sm">
      <div className="rounded-3xl bg-[#c70074]  items-center w-5/6 h-3/4 sm:h-1/2 sm:w-2/3">
        ...
        <div className="mt-4 px-6 sm:mt-8">
          <form className="max-w-sm mx-auto w-full">
            <div className="mb-5 w-full">
              ...
              <input
                type="first_name"
                id="first_name"
                className="placeholder-black bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5 bg-black opacity-60"
                placeholder="John"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="text-white bg-[#3e1f9c] hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-white font-medium rounded-lg text-sm px-4 py-2"
            >
              Submit
            </button>
          </form>
