...
<button className="text-3xl text-[#c70074]" onClick={()=>updatesingup(false)}><IoClose /></button>
</div>
<div className="mt-8">
<form className="max-w-sm mx-auto w-full">
  <div className="mb-5 w-full">
    <label className="block mb-2 text-md font-medium text-[#c70074] ">First Name</label>
    <input type="first_name" id="first_name" className="placeholder-black bg-gray-50 border border-gray-300 text-black text-sm rounded-lg block w-full p-2.5 bg-black opacity-60" placeholder="John" required />
                    ...
                    <div className="mb-5 w-full">
    <label className="block mb-2 text-md font-medium text-[#c70074] ">Last Name</label>
